...
//        System.out.println("全局异常处理");
        ...
        if (e instanceof MallException) {
            ...
            if (e.getMessage().equals(ServiceResultEnum.NOT_LOGIN_ERROR.getResult()) || e.getMessage().equals(ServiceResultEnum.TOKEN_EXPIRE_ERROR.getResult()) || e.getMessage().equals(ServiceResultEnum.USER_NULL_ERROR.getResult())) {
